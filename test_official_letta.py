"""
Test script for Official Letta integration
"""

import json
import logging
from official_letta_integration import OfficialLettaIntegration, HybridLettaSystem
...
def test_letta_direct():
    """Test direct Letta integration using the official SDK"""
    print("\n=== Testing Direct Letta Integration with Official SDK ===")
    ...
    letta = OfficialLettaIntegration()
...
def test_hybrid_system():
    """Test hybrid Letta + RAG system with official SDK"""
    print("\n=== Testing Hybrid Letta + RAG System with Official SDK ===")
